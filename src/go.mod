...
replace github.com/alexkohler/nakedret/v2 v2.0.6 => github.com/alexkohler/nakedret/v2 v2.0.5

replace github.com/jgautheron/goconst v1.8.1 => github.com/jgautheron/goconst v1.7.1

replace github.com/golangci/unconvert v0.0.0-20250410112200-a129a6e6413e => github.com/golangci/unconvert v0.0.0-20240309020433-c5143eacb3ed
